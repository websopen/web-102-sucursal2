...
import { Category, Subcategory, ClientProduct } from '../../shared/client.service';
import { NavigationPathItem } from '../types.ts';
...
const Header: React.FC<{
    ...
    return (
        <div className="bg-[#1c2a38] dark:bg-[#101921] sticky top-0 z-30 p-3 shadow-md border-b border-gray-700">
            <div className="flex items-center gap-2">
                ...
                <div className="relative flex-grow">
                    ...
                    <input
                        ...
                        className="w-full bg-[#24252a] dark:bg-[#2a2a2a] text-white/90 border border-gray-600 rounded-lg py-3 pl-10 pr-4 text-base"
                    />
                </div>
            </div>
        </div>
...
const ProductCard: React.FC<{ product: ClientProduct }> = ({ product }) => {
...
const ProductList: React.FC<{ products: ClientProduct[]; }> = ({ products }) => (
...
export const CatalogView: React.FC = () => {
    ...
    useEffect(() => {
        clientService.getCatalog().then(data => {
            setCatalog(data);
